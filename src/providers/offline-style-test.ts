    ...
    this.data = {
        {"qs":
            ...
            {"t":
              ...
              "cs":
              ["帶他們到公園或是野生動物保護區
                並且和他們一起在裏面逛","展示網路上的圖片、相片或是攝影集給他們看","給他們關於這個公園或是保護區的介紹小冊子","跟他們聊或是安排一個關於這個公園或是保護區的解說活動"],"checked":
              [false,false,false,false],
              "rs":["k",
              "v",
            "r",
            ...
            {"t":
              ...
              "cs":
              ["我可以按、可以移動與嘗試的物件"
                ,"有聲音介紹，如我可以聽到音樂、廣播或是訪談","有趣的文字介紹、條目與解釋","有趣的設計與視覺效果"],"checked":
              [false,false,false,false],
              "rs":["k",
              "a",
            "r",
            ...
            {"t":
              ...
              ["詢問好朋友他們的建議",
                "直接就
              煮就是了，不用任何的指導","從食譜中的圖片得到靈感","去讀食譜，閱讀材料與步驟，找到你認為最好的。"],"checked":
              [false,false,false,false],
              "rs":["a",
              "k",
            "v",
            ...
            {"t":
              ...
              ["這本書的封面與外觀",
                "迅速的讀
              過它","有朋友談論它並推薦它","這本書有現實生活的故事、經驗與例子"],"checked":
              [false,false,false,false],
              "rs":["v",
              "r",
            "a",
            ...
            {"t":
              ...
              ["從菜單上的文字描述選擇",
                "或是
              詢問朋友他們推薦的菜色","點你之前點過的","看看別人吃的或是菜單上的圖片"],"checked":
              [false,false,false,false],
              "rs":["r",
              "a",
            "k",
            ...
            {"t":
              ...
              "cs":
              ["明確的書面指示，並列出如何拍照
                的重點","展示許多好的與不好的照片的例子並且如何改善它們的方法。","相機的結構圖並且標出每個部份的功能","一個可以讓人問問題而且討論相機的功能的機會，如網站上的討論區"],"checked":
              [false,false,false,false],
              "rs":["r",
              "k",
            "v",
            ...
            {"t":
              ...
              "cs":
              ["打電話、寫信或是寄電子郵件給他
                們","向他們描述這個活動最重要的部份","給他們一份印出來的行程表","使用地圖或是網站來展示"],"checked":
              [false,false,false,false],
              "rs":["k",
              "a",
            "r",
            ...
            {"t":
              ...
              "cs":
              ["寫下幾個關鍵字，並反覆地練習你
                的演說","收集許多例子與故事，讓這個演說變得實際有用","做圖表、收集圖片來解釋事物","寫下你的講稿，並且反覆的閱讀它"],"checked":
              [false,false,false,false],
              "rs":["a",
              "k",
            "v",
            ...
            {"t":
              ...
              "cs":
              ["使用一個塑膠的膝蓋模型，向你展
                示哪邊出了問題","用一個圖來解釋","仔細的描述問題在那裏","給你一個網站，或是介紹，讓你能夠閱讀"],"checked":
              [false,false,false,false],
              "rs":["k",
              "v",
            "a",
            ...
            {"t":
              ...
              "cs":
              ["從你已經做過的試題中舉實例說明"
                ,"使用詳細的文字說明來描述結果","測試者使用口頭方式來解說結果","使用圖表來展示你的成果"],"checked":
              [false,false,false,false],
              "rs":["k"
            ,"r","a","v"]}],"model":
            {"r":
