...
export class OfflineHandbook {
  ...
  constructor() {
    ...
    this.data = {
      "catagories": [
        { "t": "法源", "color": "#9ef", "icon": "law", "ion": {"icon":"bonfire"}},
        { "t": "申請", "color": "#f99", "icon": "edit", "ion": {"icon":"happy"}},
        { "t": "家庭", "color": "#f93", "icon": "home", "ion": {"icon":"home"}},
        { "t": "學校", "color": "#cc5", "icon": "student", "ion": {"icon":"school"}},
        { "t": "交友", "color": "#fca", "icon": "add user", "ion": {"icon":"chatbubbles"}},
        { "t": "計畫", "color": "#0f0", "icon": "hourglass half", "ion": {"icon":"alarm"}},
        { "t": "資源", "color": "#c9c", "icon": "in cart", "ion": {"icon":"apps"}},
        { "t": "審議", "color": "#f66", "icon": "protect", "ion": {"icon":"contacts"}}
      ],
      "faqs": [
      { "q" : "不上學，合法嗎？",
        "c" : "法源",          
      ...
      { "q" : "學校也要改嗎？",
        "c" : "學校",
        "as" : [
          "學校當然有要改革之處，十幾年來一直在教改。",
          "自學(非學校教育)若在法條、執行有不合宜之處，要改的話，也要發起修法或檢舉、申訴。",
          "這兩邊的法條、執行面都是分開的。"
        ],
        "es": []
      },
